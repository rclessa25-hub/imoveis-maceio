...
// SISTEMA DE LOGGING OTIMIZADO PARA PDFs

console.log('📄 pdf-logger.js carregado - Sistema de Logs Otimizado');
...
// 5. SISTEMA DE VISUALIZAÇÃO (MODAL)
window.logPdfViewer = {
    opening: (propertyId) => {
...
window.logPdfStart = function(operation) {
    ...
    return Date.now(); // Retorna timestamp para medição de performance
};
...
// ========== INICIALIZAÇÃO ==========
console.log('✅ Sistema de logging de PDFs completamente carregado');
console.log('📊 Níveis disponíveis: upload, delete, preview, edit, viewer, debug');
console.log('💡 Use: window.logPdfUpload.success("arquivo.pdf")');
